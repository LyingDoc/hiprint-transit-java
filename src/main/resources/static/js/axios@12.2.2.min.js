...
!function (e, t) {
    ...
    var S, x = Object.prototype.toString, R = Object.getPrototypeOf, k = Symbol.iterator, j = Symbol.toStringTag,
        T = (S = Object.create(null), function (e) {
            var t = x.call(e);
    ...
    var C = A("ArrayBuffer");
    var U = P("string"), F = P("function"), B = P("number"), D = function (e) {
            return null !== e && "object" === f(e)
        }, I = function (e) {
            if ("object" !== T(e)) return !1;
            var t = R(e);
            return !(null !== t && t !== Object.prototype && null !== Object.getPrototypeOf(t) || j in e || k in e)
        }, q = A("Date"), M = A("File"), z = A("Blob"), H = A("FileList"), J = A("URLSearchParams"),
        W = b(["ReadableStream", "Request", "Response", "Headers"].map(A), 4), K = W[0], V = W[1], G = W[2], X = W[3];
    ...
    }), re = A("HTMLFormElement"), ne = function (e) {
        var t = Object.prototype.hasOwnProperty;
        return function (e, r) {
            return t.call(e, r)
        }
    }(), oe = A("RegExp"), ie = function (e, t) {
    ...
    var ae, se, ue, ce, fe = A("AsyncFunction"),
        ...
        he = {
            ...
            isFormData: function (e) {
                var t;
                return e && ("function" == typeof FormData && e instanceof FormData || F(e.append) && ("formdata" === (t = T(e)) || "object" === t && F(e.toString) && "[object FormData]" === e.toString()))
            },
            ...
            merge: function e() {
                ...
                }, a = 0, s = arguments.length; a < s; a++) arguments[a] && $(arguments[a], i);
                return o
            },
    ...
    ["ERR_BAD_OPTION_VALUE", "ERR_BAD_OPTION", "ECONNABORTED", "ETIMEDOUT", "ERR_NETWORK", "ERR_FR_TOO_MANY_REDIRECTS", "ERR_DEPRECATED", "ERR_BAD_RESPONSE", "ERR_BAD_REQUEST", "ERR_CANCELED", "ERR_NOT_SUPPORT", "ERR_INVALID_URL"].forEach((function (e) {
        ...
        he.toFlatObject(e, a, (function (e) {
            return e !== Error.prototype
        }), (function (e) {
            return "isAxiosError" !== e
        }));
        var s = e && e.message ? e.message : "Error", u = null == t && e ? e.code : t;
        return de.call(a, s, u, r, n, o), e && null == a.cause && Object.defineProperty(a, "cause", {
            value: e,
            configurable: !0
    ...
    var je = function () {
        ...
        }(), Te = {silentJSONParsing: !0, forcedJSONParsing: !0, clarifyTimeoutError: !1}, Ae = {
            isBrowser: !0,
            classes: {
        ...
        transformRequest: [function (e, t) {
            ...
            if (i) {
                if (n.indexOf("application/x-www-form-urlencoded") > -1) return function (e, t) {
                    return Ee(e, new Ue.classes.URLSearchParams, s({
    ...
    var De = Be,
        Ie = he.toObjectSet(["age", "authorization", "content-length", "content-type", "etag", "expires", "from", "host", "if-modified-since", "if-unmodified-since", "last-modified", "location", "max-forwards", "proxy-authorization", "referer", "retry-after", "user-agent"]),
        qe = Symbol("internals");
    ...
    var Je = function (e, t) {
        ...
        return y(r, [{
            key: "set", value: function (e, t, r) {
                ...
                if (he.isPlainObject(e) || e instanceof this.constructor) i(e, t); else if (he.isString(e) && (e = e.trim()) && !/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(e.trim())) i(function (e) {
                ...
                }(e), t); else if (he.isObject(e) && he.isIterable(e)) {
                    ...
                    try {
                        for (f.s(); !(u = f.n()).done;) {
                            var l = u.value;
                            if (!he.isArray(l)) throw TypeError("Object iterator must return a key-value pair");
                            c[s = l[0]] = (a = c[s]) ? he.isArray(a) ? [].concat(g(a), [l[1]]) : [a, l[1]] : l[1]
                        }
                    } catch (e) {
                        f.e(e)
                    } finally {
            ...
            key: "accessor", value: function (e) {
                var t = (this[qe] = this[qe] = {accessors: {}}).accessors, r = this.prototype;
    ...
    function it(e, t) {
        ...
        return he.forEach(Object.keys(s(s({}, e), t)), (function (n) {
    ...
    var at, st = function (e) {
            var t = it({}, e), r = t.data, n = t.withXSRFToken, o = t.xsrfHeaderName, i = t.xsrfCookieName, a = t.headers,
                s = t.auth;
            if (t.headers = a = We.from(a), t.url = ke(nt(t.baseURL, t.url, t.allowAbsoluteUrls), e.params, e.paramsSerializer), s && a.set("Authorization", "Basic " + btoa((s.username || "") + ":" + (s.password ? unescape(encodeURIComponent(s.password)) : ""))), he.isFormData(r)) if (Ue.hasStandardBrowserEnv || Ue.hasStandardBrowserWebWorkerEnv) a.setContentType(void 0); else if (he.isFunction(r.getHeaders)) {
                var u = r.getHeaders(), c = ["content-type", "content-length"];
                Object.entries(u).forEach((function (e) {
                    var t = b(e, 2), r = t[0], n = t[1];
                    c.includes(r.toLowerCase()) && a.set(r, n)
                }))
            }
            if (Ue.hasStandardBrowserEnv && (n && he.isFunction(n) && (n = n(t)), n || !1 !== n && tt(t.url))) {
                var f = o && i && rt.read(i);
                f && a.set(o, f)
            }
            return t
        }, ut = "undefined" != typeof XMLHttpRequest && function (e) {
            return new Promise((function (t, r) {
                var n, o, i, a, s, u = st(e), c = u.data, f = We.from(u.headers).normalize(), l = u.responseType,
            ...
            var o, i = lt(e, t), a = 0, s = function (e) {
                o || (o = !0, n && n(e))
            };
        ...
        }, dt = he.isFunction, vt = {Request: (at = he.global).Request, Response: at.Response}, yt = he.global,
        mt = yt.ReadableStream, bt = yt.TextEncoder, gt = function (e) {
            try {
            ...
            var t = e = he.merge.call({skipUndefined: !0}, vt, e), r = t.fetch, n = t.Request, o = t.Response,
                i = r ? dt(r) : "function" == typeof fetch, a = dt(n), c = dt(o);
            if (!i) return !1;
            var f, l = i && dt(mt), p = i && ("function" == typeof bt ? (f = new bt, function (e) {
                return f.encode(e)
            }) : function () {
                ...
                var e = !1, t = new n(Ue.origin, {
                    body: new mt, method: "POST", get duplex() {
                        return e = !0, "half"
                    }
            ...
            var m = function () {
                ...
                var e = h(u().mark((function e(t, r) {
                    ...
                    return u().wrap((function (e) {
                        for (; ;) switch (e.prev = e.next) {
                            case 0:
                                return n = he.toFiniteNumber(t.getContentLength()), e.abrupt("return", null == n ? m(r) : n);
                            case 2:
                            case"end":
                                return e.stop()
                        }
            ...
            return function () {
                var e = h(u().mark((function e(t) {
                    var i, c, f, l, p, h, m, w, E, O, S, x, R, k, j, T, A, P, L, N, _, C, U, F, B, D, I, q, M, z, H, J, W,
                        K, V, G;
                    return u().wrap((function (e) {
                        for (; ;) switch (e.prev = e.next) {
                            case 0:
                                if (i = st(t), c = i.url, f = i.method, l = i.data, p = i.signal, h = i.cancelToken, m = i.timeout, w = i.onDownloadProgress, E = i.onUploadProgress, O = i.responseType, S = i.headers, x = i.withCredentials, R = void 0 === x ? "same-origin" : x, k = i.fetchOptions, j = r || fetch, O = O ? (O + "").toLowerCase() : "text", T = ct([p, h && h.toAbortSignal()], m), A = null, P = T && T.unsubscribe && function () {
                                    T.unsubscribe()
                                }, e.prev = 6, e.t0 = E && d && "get" !== f && "head" !== f, !e.t0) {
                                    e.next = 13;
                                    break
                                }
                            ...
                            case 13:
                                ...
                                N = new n(c, {
                                    ...
                                    body: l,
                                    duplex: "half"
                                }), he.isFormData(l) && (_ = N.headers.get("content-type")) && S.setContentType(_), N.body && (C = Ze(L, Qe(et(E))), U = b(C, 2), F = U[0], B = U[1], l = ht(N.body, 65536, F, B));
                            case 17:
                                return he.isString(R) || (R = R ? "include" : "omit"), D = a && "credentials" in n.prototype, I = s(s({}, k), {}, {
                                    signal: T,
                                ...
                                }), A = a && new n(c, I), e.next = 23, a ? j(A, k) : j(c, I);
                            case 23:
                                return q = e.sent, M = v && ("stream" === O || "response" === O), v && (w || M && P) && (z = {}, ["status", "statusText", "headers"].forEach((function (e) {
                                    z[e] = q[e]
                                })), H = he.toFiniteNumber(q.headers.get("content-length")), J = w && Ze(H, Qe(et(w), !0)) || [], W = b(J, 2), K = W[0], V = W[1], q = new o(ht(q.body, 65536, K, (function () {
                                    V && V(), P && P()
                                })), z)), O = O || "text", e.next = 29, y[he.findKey(y, O) || "text"](q, t);
                            case 29:
                            ...
                            case 36:
                                ...
                                throw Object.assign(new de("Network Error", de.ERR_NETWORK, t, A), {cause: e.t2.cause || e.t2});
                            case 41:
        ...
        }, Et = new Map, Ot = function (e) {
            for (var t, r, n = e ? e.env : {}, o = n.fetch, i = [n.Request, n.Response, o], a = i.length, s = Et; a--;) t = i[a], void 0 === (r = s.get(t)) && s.set(t, r = a ? new Map : wt(n)), s = r;
            return r
        };
    Ot();
    ...
    var xt = function (e) {
        ...
        for (var r, n, o = (e = he.isArray(e) ? e : [e]).length, i = {}, a = 0; a < o; a++) {
            var s = void 0;
            if (n = r = e[a], !Rt(r) && void 0 === (n = St[(s = String(r)).toLowerCase()])) throw new de("Unknown adapter '".concat(s, "'"));
        ...
        if (!n) {
            ...
            throw new de("There is no suitable adapter to dispatch the request " + (o ? u.length > 1 ? "since :\n" + u.map(xt).join("\n") : " " + xt(u[0]) : "as no adapter specified"), "ERR_NOT_SUPPORT")
        }
        return n
    };
    ...
    function Tt(e) {
        return jt(e), e.headers = We.from(e.headers), e.data = Ke.call(e, e.transformRequest), -1 !== ["post", "put", "patch"].indexOf(e.method) && e.headers.setContentType("application/x-www-form-urlencoded", !1), kt(e.adapter || De.adapter, e)(e).then((function (t) {
            return jt(e), t.data = Ke.call(e, e.transformResponse, t), t.headers = We.from(t.headers), t
        }), (function (t) {
            return Ve(t) || (jt(e), t && t.response && (t.response.data = Ke.call(e, e.transformResponse, t.response), t.response.headers = We.from(t.response.headers))), Promise.reject(t)
        }))
    }
    ...
    var Nt = {
    ...
    }, _t = Nt.validators, Ct = function () {
        function e(t) {
            d(this, e), this.defaults = t || {}, this.interceptors = {request: new je, response: new je}
        }
        ...
        return y(e, [{
            ...
            key: "_request", value: function (e, t) {
                ...
                }, !1), null != o && (he.isFunction(o) ? t.paramsSerializer = {serialize: o} : Nt.assertOptions(o, {
                    encode: _t.function,
    ...
    var It = Dt;
    var qt = function e(t) {
        var r = new Ut(t), n = O(Ut.prototype.request, r);
        return he.extend(n, Ut.prototype, r, {allOwnKeys: !0}), he.extend(n, r, null, {allOwnKeys: !0}), n.create = function (r) {
            return e(it(t, r))
        }, n
    }(De);
    return qt.Axios = Ut, qt.CanceledError = Ge, qt.CancelToken = Bt, qt.isCancel = Ve, qt.VERSION = At, qt.toFormData = Ee, qt.AxiosError = de, qt.Cancel = qt.CanceledError, qt.all = function (e) {
    ...
    }, qt.getAdapter = kt, qt.HttpStatusCode = It, qt.default = qt, qt
}));
