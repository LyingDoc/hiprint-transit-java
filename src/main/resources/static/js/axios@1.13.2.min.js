...
!function (e, t) {
    ...
    function s() {
        ...
        t.wrap = l;
        var d = "suspendedStart", h = "executing", v = "completed", y = {};
    ...
    var S, x = Object.prototype.toString, R = Object.getPrototypeOf, k = Symbol.iterator, T = Symbol.toStringTag,
    ...
    var ve = he.prototype, ye = {};
    ["ERR_BAD_OPTION_VALUE", "ERR_BAD_OPTION", "ECONNABORTED", "ETIMEDOUT", "ERR_NETWORK", "ERR_FR_TOO_MANY_REDIRECTS", "ERR_DEPRECATED", "ERR_BAD_RESPONSE", "ERR_BAD_REQUEST", "ERR_CANCELED", "ERR_NOT_SUPPORT", "ERR_INVALID_URL"].forEach((function (e) {
        ye[e] = {value: e}
    })), Object.defineProperties(he, ye), Object.defineProperty(ve, "isAxiosError", {value: !0}), he.from = function (e, t, r, n, o, i) {
        ...
        var u = e && e.message ? e.message : "Error", s = null == t && e ? e.code : t;
    ...
    function Ee(e, t, r) {
        ...
        var l = [], p = Object.assign(we, {defaultVisitor: c, convertValue: s, isVisitable: me});
    ...
    var Te = function () {
        ...
        _e = Pe && window.location.href || "http://localhost", Ue = u(u({}, Object.freeze({
            __proto__: null,
            hasBrowserEnv: Pe,
    ...
    var Be = {
        ...
        transformRequest: [function (e, t) {
            var r, n = t.getContentType() || "", o = n.indexOf("application/json") > -1, i = de.isObject(e);
    ...
    function it(e, t) {
        ...
        function n(e, t, r, n) {
            return de.isPlainObject(e) && de.isPlainObject(t) ? de.merge.call({caseless: n}, e, t) : de.isPlainObject(t) ? de.merge({}, t) : de.isArray(t) ? t.slice() : t
        }
    ...
    var at, ut = function (e) {
            ...
            if (t.headers = a = We.from(a), t.url = ke(nt(t.baseURL, t.url, t.allowAbsoluteUrls), e.params, e.paramsSerializer), u && a.set("Authorization", "Basic " + btoa((u.username || "") + ":" + (u.password ? unescape(encodeURIComponent(u.password)) : ""))), de.isFormData(r)) if (Ue.hasStandardBrowserEnv || Ue.hasStandardBrowserWebWorkerEnv) a.setContentType(void 0); else if (de.isFunction(r.getHeaders)) {
                var s = r.getHeaders(), c = ["content-type", "content-length"];
            ...
            return new Promise((function (t, r) {
                var n, o, i, a, u, s = ut(e), c = s.data, f = We.from(s.headers).normalize(), l = s.responseType,
                    p = s.onUploadProgress, d = s.onDownloadProgress;
            ...
            var o, i = lt(e, t), a = 0, u = function (e) {
                o || (o = !0, n && n(e))
            };
        ...
        }, ht = de.isFunction, vt = {Request: (at = de.global).Request, Response: at.Response}, yt = de.global,
        mt = yt.ReadableStream, bt = yt.TextEncoder, gt = function (e) {
            ...
            var t = e = de.merge.call({skipUndefined: !0}, vt, e), r = t.fetch, n = t.Request, o = t.Response,
                i = r ? ht(r) : "function" == typeof fetch, a = ht(n), c = ht(o);
            if (!i) return !1;
            var f, l = i && ht(mt), p = i && ("function" == typeof bt ? (f = new bt, function (e) {
                return f.encode(e)
            }) : function () {
            ...
            return function () {
                var e = d(s().mark((function e(t) {
                    var i, c, f, l, p, d, m, w, E, O, S, x, R, k, T, j, A, P, L, N, C, _, U, F, B, D, I, q, M, z, H, J, W,
                        K, V, G;
                    return s().wrap((function (e) {
                        for (; ;) switch (e.prev = e.next) {
                            case 0:
    ...
    var Nt = {
        ...
        var t;
        return y(e, [{
            key: "request", value: (t = d(s().mark((function e(t, r) {
                var n, o;
                return s().wrap((function (e) {
                    for (; ;) switch (e.prev = e.next) {
                        case 0:
            ...
            key: "_request", value: function (e, t) {
                ...
                }, !1), null != o && (de.isFunction(o) ? t.paramsSerializer = {serialize: o} : Nt.assertOptions(o, {
                    encode: Ct.function,
    ...
    var qt = function e(t) {
        ...
        return de.extend(n, Ut.prototype, r, {allOwnKeys: !0}), de.extend(n, r, null, {allOwnKeys: !0}), n.create = function (r) {
            return e(it(t, r))
        }, n
    }(De);
